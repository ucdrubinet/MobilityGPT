...
# ##############
    ...
    #     traj_first_n = traj[:n]
    #     # context = [train_dataset.BOS_TOKEN, traj_first_n]
    ...
    #             break
    #         else:
    #             input_t.append(int(train_dataset.itos[int(i)]))
                
    #     input_length = porto_geo[porto_geo['geo_id'].isin(input_t)].length.sum()
    ...
    #             break
    #         else:
    #             candidate_0.append(int(train_dataset.itos[int(i)]))
                
    #     length_1 = porto_geo[porto_geo['geo_id'].isin(candidate_0)].length.sum()
    ...
    #             break
    #         else:
    #             candidate_1.append(int(train_dataset.itos[int(i)]))
    #     length_2 = porto_geo[porto_geo['geo_id'].isin(candidate_1)].length.sum()
        
    #     choice = np.argmin([abs(input_length - length_1), abs(input_length - length_2)])
    #     d = {'input': input_t, 'candidate_0':candidate_0, 'candidate_1':candidate_1, 'choice':choice}
